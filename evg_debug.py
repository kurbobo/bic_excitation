...
def zfunc_nonlean(z, t, delta, chi_2, chi_3, gamma_U, gamma_V, gamma_C, s, g):
    ...
    return [(-1j * delta- gamma ) * b+ 2j * alpha * np.abs(B_20) ** 2 *b
...
# z2, infodict2=apx.odeintz(zfunc_nonlean_2, z0, t, args=(delta, chi_2, chi_3, gamma_U, gamma_V, gamma_C, s, g), full_output=True)
